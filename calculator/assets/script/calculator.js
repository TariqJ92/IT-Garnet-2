function calculate() {
    ...
    if ($( "#myform" ).valid()) {
        ...
        /* if the operator was "Sub" then set result to subtraction */
        if (operator == "Sub") {
            if(operand1fp - operand2fp) {
                result = operand1fp-operand2fp
            }
        ...
        /* if the operator was "Mul" then set result to multiplication */
        if (operator == "Mul") {
            if(operand1fp * operand2fp) {
                result = operand1fp*operand2fp;
            }
        ...
        /* if the operator was "Div" then set result to division */
        if (operator == "Div") {
            if(operand1fp / operand2fp) {
                result = operand1fp/operand2fp;
            }
